...
do
    ...
    antsApplyTransforms \
        -d 3 \
        -i ${original} \
        -o tpl-MNI152NLin6Asym_atlas-Schaefer2018v0143_res-01_desc-${order}ParcelsAllNetworks_dseg.nii.gz  \
    ...
    antsApplyTransforms \
        -d 3 \
        -i ${original} \
        -o tpl-MNI152NLin2009cAsym_atlas-Schaefer2018v0143_res-01_desc-${order}ParcelsAllNetworks_dseg.nii.gz  \
